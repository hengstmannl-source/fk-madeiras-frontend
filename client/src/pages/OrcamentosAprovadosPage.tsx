  ...
  const confirmarEntrega = () => {
    ...
    entregarFisicamente.mutate({ id: entregaAlvo.id }, {
      onSuccess: (resultado) => {
        ...
        toast.success(`Entrega registrada: ${resultado.pecasEntregues} peça(s) baixada(s) do estoque.${avisoDeficit}`);
        setEntregaAlvo(null);
        invalidarEntrega();
      },
      onError: (erro) => toast.error(erro.message),
