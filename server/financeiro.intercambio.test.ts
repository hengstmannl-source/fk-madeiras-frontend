...
describe("intercâmbio de lançamentos financeiros", () => {
  ...
  it("rejeita cabeçalhos inválidos, referências duplicadas e datas impossíveis", () => {
    ...
    const csv = "referencia;tipo;descricao;categoria;valor;data_emissao;data_vencimento;competencia;contraparte;observacoes\nIMP-001;receber;Teste;Receitas;10;30/02/2026;15/08/2026;;;;\nIMP-001;pagar;Outro;Despesas;20;01/08/2026;15/08/2026;;;;";
  ...
  it("aceita o formato ISO legado e o normaliza para a mesma data interna", () => {
    const csv = "referencia;tipo;descricao;categoria;valor;data_emissao;data_vencimento;competencia;contraparte;observacoes\nLEGADO-1;pagar;Compra;Despesas;10;2026-08-01;2026-08-10;2026-08-01;;";
  ...
  it("recusa o arquivo inteiro quando a categoria não existe ou a referência já foi usada", () => {
    const csv = "referencia;tipo;descricao;categoria;valor;data_emissao;data_vencimento;competencia;contraparte;observacoes\nEXISTENTE;receber;Venda;Receitas;10;01/08/2026;15/08/2026;;;;\nNOVA;pagar;Compra;Inexistente;20;01/08/2026;15/08/2026;;;;";
  ...
  it("associa a categoria encontrada e produz um lote pronto para inserção atômica", () => {
    const csv = "referencia;tipo;descricao;categoria;valor;data_emissao;data_vencimento;competencia;contraparte;observacoes\nNOVA-1;pagar;Compra de insumos;Despesas;20;01/08/2026;15/08/2026;;;;";
